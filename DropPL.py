...
#    Loss = tf.add(tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=pred, labels=y)),tf.multiply(alpha,tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=pred1, labels=PLy))))
    ...
    #sigmoid
    Loss = tf.add(tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(logits=pred, labels=y)),tf.multiply(alpha,tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(logits=pred1, labels=PLy))))
